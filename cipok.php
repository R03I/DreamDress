...
<body>
	...
	<nav class="navbar navbar-expand-lg sticky-top navbar-light bg-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav mr-auto float-left">
              ...
              <a class="nav-item nav-link active" href="cipok.php">Cipők</a>
          </div>
		...
		<div id="carouselExampleSlidesOnly" data-interval="7000" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<img class="d-block w-100" src="img/cipo1.jpg">
    			</div>
    			<div class="carousel-item">
      				<img class="d-block w-100" src="img/cipo2.jpg">
    			</div>
    			<div class="carousel-item">
			      <img class="d-block w-100" src="img/cipo3.jpg">
    			</div>
  			</div>
		</div>
  ...
  <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
    <ul class="navbar-nav col-lg-12 justify-content-center">
      ...
      <li class="nav-item col-lg-2">
        <a class="nav-link col-lg-12" id="csizma"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="csizma" value="Magassarkú"> </a>
      </li>
      <li class="nav-item col-lg-2">
        <a class="nav-link col-lg-12" id="magassarku"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="magassarku" value="Szandal"></a>
      </li>
      <li class="nav-item col-lg-2">
        <a class="nav-link col-lg-12" id="szandal"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="szandal" value="Csizma"></a>
      </li>
      <li class="nav-item col-lg-2">
      <a class="nav-link col col-lg-12" id="futo_cipo"><input type="button" class="col-lg-12 btn btn-outline-secondary" id="futo_cipo" value="Futó cipő"></a>
      </li>
    </ul>
  </div>
</nav>
    ...
    $leker = new ruhak();
    $leker->termek_megjelenit($leker->termek_leker("cipo"));
    ?>s
    </div>
    <!-- FOOTER -->
...
<div class="modal fade" id="hirlevel_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <script type="text/javascript" src="js/rage3.js"></script>
