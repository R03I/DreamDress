...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
	<title>DREAM DRESS - Felsők</title>
...
<body>
    ...
    <strong>Sikeresen kiléptél.</strong> Várunk vissza <strong id="bye">Béla</strong>.
    </div>
		<div id="carouselExampleSlidesOnly" data-interval="7000" class="carousel slide" data-ride="carousel">
			<div class="carousel-inner">
    			<div class="carousel-item active">
      				<img class="d-block w-100" src="img/felso3.jpg">
    			</div>
    			<div class="carousel-item">
      				<img class="d-block w-100" src="img/felso.jpg">
    			</div>
    			<div class="carousel-item">
			      <img class="d-block w-100" src="img/felso2.jpg">
    			</div>
  			</div>
		</div>
  ...
  <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
    <ul class="navbar-nav col-lg-12 justify-content-center">
      ...
      <li class="nav-item col-lg-2" id=" polok">
        <a class="nav-link col-lg-12" id=" polok"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="polok" value="pólók"> </a>
      </li>
      <li class="nav-item col-lg-2">
        <a class="nav-link col-lg-12"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="topok" value="topok"></a>
      </li>
      <li class="nav-item col-lg-2">
        <a class="nav-link col-lg-12" id="bluzok"> <input type="button" class="btn btn-outline-secondary col-lg-12" id="bluz_sz" value="blúzok"></a>
      </li>
      <li class="nav-item col-lg-2">
      <a class="nav-link col col-lg-12" id="hossz_polok"><input type="button" class="col-lg-12 btn btn-outline-secondary" id="hossz_polok" value="hosszú ujjú"></a>
      </li>
    </ul>
  </div>
</nav>
    ...
    $leker = new ruhak();
    $leker->termek_megjelenit($leker->termek_leker("felso"));
    ?>
    </div>
    <!-- FOOTER -->
...
<div class="modal fade" id="hirlevel_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <script type="text/javascript" src="js/rage2.js"></script>
